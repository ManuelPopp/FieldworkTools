...
##CropPointCloud----------------------------------------------------------------
class MergePointCloud(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        las_paths = self.parameterAsFile(parameters, self.POINTCLOUDS, context)
        ...
        cmd = [rscript_exe, script_name, las_paths, output_path]
    ...
    def name(self):
        return "merge_pointclouds"

    def displayName(self):
        return "Merge Point Clouds"
